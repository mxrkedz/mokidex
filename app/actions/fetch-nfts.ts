...
export async function fetchWalletNFTs() {
  ...
  const url =
    'https://deep-index.moralis.io/api/v2.2/0x61759fb5255532f8f977d0a51b7037651becac74/nft?chain=ronin&format=decimal&limit=25&token_addresses%5B0%5D=0x47b5a7c2e4f07772696bbf8c8c32fe2b9eabd550&token_addresses%5B1%5D=0x3a3ea46230688a20ee45ec851dc81f76371f1235&media_items=true&include_prices=true';
